...
const translations = {
  ko: {
    ...
    'career.desc': '관광산업 15개 취업 분야 지도와 직무·성향별 진로 안내로 시작해, 관광기업·공공기관·관광재단·연구기관의 채용정보와 자격·준비자료까지 제공합니다.<br />관광 전공자의 길은 취업과 창업만 있는 것이 아닙니다.',
  ...
  zh: {
    ...
    'career.desc': '从旅游产业15个就业领域地图、职务解析与性格倾向进路指南开始，进而提供旅游企业、公共机构、旅游财团及研究机构的招聘信息与资格·准备资料。<br />旅游专业的道路并不只有就业和创业。',
