...
const translations = {
  ko: {
    ...
    // 진로·취업
    'career.label': 'Career Resources',
    'career.title': '관광산업',
    'career.titleStrong': '진로·취업 가이드',
    'career.desc': '관광산업 14개 취업 분야 지도와 직무·성향별 진로 안내로 시작해, 관광기업·공공기관·관광재단·연구기관의 채용정보와 자격·준비자료까지 제공합니다.<br />관광 전공자의 길은 취업과 창업만 있는 것이 아닙니다.',
    'career.c1.title': '진로·취업',
    'career.c1.desc': '산업군 지도 · 직무 · 채용정보',
    'career.c1.cta': '최근 채용정보 보기 →',
    'career.c2.title': '관광창업',
    'career.c2.desc': '여행사 운영 · 사업계획',
    'career.c2.cta': '창업자료 보기 →',
    'career.c3.title': '수업자료',
    'career.c3.desc': '스마트관광 · 관광창업 강의자료',
    'career.c3.cta': '교육자료 보기 →',
  ...
  en: {
    ...
    // Career Resources
    'career.label': 'Career Resources',
    'career.title': 'Tourism',
    'career.titleStrong': 'Career Resources',
    'career.desc': 'Start with a map of 14 career fields across the tourism industry, plus job-role explanations and a strengths-based guide, then move on to hiring information, qualifications and preparation resources from tourism companies, public agencies, tourism foundations and research institutes.<br />Employment and entrepreneurship are not the only paths for a tourism major.',
    'career.c1.title': 'Careers & Paths',
    'career.c1.desc': 'Industry map · Roles · Job postings',
    'career.c1.cta': 'View latest openings →',
    'career.c2.title': 'Tourism Startup',
    'career.c2.desc': 'Agency operations · Business planning',
    'career.c2.cta': 'View startup materials →',
    'career.c3.title': 'Course Materials',
    'career.c3.desc': 'Smart tourism · Tourism entrepreneurship lectures',
    'career.c3.cta': 'View learning hub →',
  ...
  zh: {
    ...
    'career.label': 'Career Resources',
    'career.title': '旅游产业',
    'career.titleStrong': '职业发展指南',
    'career.desc': '从旅游产业14个就业领域地图、职务解析与性格倾向进路指南开始，进而提供旅游企业、公共机构、旅游财团及研究机构的招聘信息与资格·准备资料。<br />旅游专业的道路并不只有就业和创业。',
    'career.c1.title': '职业发展',
    'career.c1.desc': '产业地图 · 职务 · 招聘信息',
    'career.c1.cta': '查看最新招聘 →',
    'career.c2.title': '旅游创业',
    'career.c2.desc': '旅行社运营 · 商业计划',
    'career.c2.cta': '查看创业资料 →',
    'career.c3.title': '课程资料',
    'career.c3.desc': '智慧旅游 · 旅游创业讲义',
    'career.c3.cta': '查看教育资料 →',
