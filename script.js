...
const translations = {
  ko: {
    ...
    'career.label': 'Career',
    'career.title': '관광산업',
    'career.titleStrong': '취업·진로',
    'career.desc': '관광기업·공공기관·관광재단·연구기관의 채용정보와 직무·자격·취업 준비자료를 제공합니다.<br />관광 전공자의 길은 취업과 창업만 있는 것이 아닙니다.',
    'career.c1.title': '취업·진로',
    'career.c1.desc': '채용공고 · 직무 · 자격정보',
  ...
  en: {
    ...
    // Career
    'career.label': 'Career',
    'career.title': 'Tourism Industry',
    'career.titleStrong': 'Careers',
    'career.desc': 'Hiring information, job roles, qualifications and preparation resources across tourism companies, public agencies, tourism foundations and research institutes.<br />Employment and entrepreneurship are not the only paths for a tourism major.',
    'career.c1.title': 'Careers',
    'career.c1.desc': 'Job postings · Roles · Qualifications',
  ...
  zh: {
    ...
    'career.label': 'Career',
    'career.title': '旅游产业',
    'career.titleStrong': '就业·职业发展',
    'career.desc': '提供旅游企业、公共机构、旅游财团及研究机构的招聘信息与职务·资格·就业准备资料。<br />旅游专业的道路并不只有就业和创业。',
    'career.c1.title': '就业·职业发展',
    'career.c1.desc': '招聘公告 · 职务 · 资格信息',
