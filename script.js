  ...
  showSubPageFull(`
    <div class="co-fullbg-wrap">
      ...
      <div class="sp-wrap" style="padding-top:48px;padding-bottom:0;">
        ...
        <div style="background:#fff;border:1px solid #e8e8e4;border-radius:16px;padding:20px 24px;border-left:1.5px solid #3B6259;display:flex;flex-direction:column;justify-content:center;">
